...
class _MyAppState extends State<MyApp> {
      ...
      home: Scaffold(
        ...
        body: Column(
          children: [
            ...
            _navigateToPeripheralPage(),
            //_buildButtonSelectedDeviceIds(),
            /*ElevatedButton(
                child: Text('Go to PheripheralDetailPage'),
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
  ...
  Widget _navigateToPeripheralPage() {
    return Builder(
      builder: (context) => ElevatedButton(
          ...
          onPressed: () {
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: ((context) =>
                        PeripheralDetailPage(selectedItems: selectedItems))));
          }),
    );
  }
  /*Widget _buildButtonSelectedDeviceIds() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
      children: <Widget>[
        ElevatedButton(
