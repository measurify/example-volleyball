...
class ConfigPage extends StatefulWidget {
  ...
  ConfigPage({required this.globals //required
      });
...
class _ConfigPageState extends State<ConfigPage> {
  ...
  TextEditingController _bleServiceIdEditingController =
  ...
  TextEditingController _imuCharacteristicIdEditingController =
      TextEditingController();
  TextEditingController _envCharacteristicIdEditingController =
      TextEditingController();
  TextEditingController _orientationCharacteristicIdEditingController =
      TextEditingController();
  ...
  Future<void> initializeTextControllers() async {
    ...
    _imuCharacteristicIdEditingController.text =
        widget.globals.imuCharacteristicId;
    _envCharacteristicIdEditingController.text =
        widget.globals.envCharacteristicId;
    _orientationCharacteristicIdEditingController.text =
  ...
  Future<void> saveSharedPreferences() async {
    ...
    await widget.globals.prefs
        .setString('imuCharacteristicId', widget.globals.imuCharacteristicId);
    await widget.globals.prefs
        .setString('envCharacteristicId', widget.globals.envCharacteristicId);
    await widget.globals.prefs.setString('orientationCharacteristicId',
        widget.globals.orientationCharacteristicId);
  }
  ...
  Future<void> resetConfigVariables() async {
    ...
    await widget.globals.prefs
        .setString('imuCharacteristicId', defaults.imuCharacteristicId);
    await widget.globals.prefs
        .setString('envCharacteristicId', defaults.envCharacteristicId);
    await widget.globals.prefs.setString(
        'orientationCharacteristicId', defaults.orientationCharacteristicId);
