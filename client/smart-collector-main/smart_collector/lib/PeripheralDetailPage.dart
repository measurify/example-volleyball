...
class _PeripheralDetailPageState extends State<PeripheralDetailPage> {
  ...
  void initState() {
    super.initState();
    globals.selectedItems = widget.selectedItems;
  ...
  void _handleServiceDiscovery(
    ...
    /*if (serviceId == WOODEMI_SERV__COMMAND &&
        characteristicIds.contains(WOODEMI_CHAR__COMMAND_REQUEST)) {
      QuickBlue.setNotifiable(deviceId, serviceId,
          WOODEMI_CHAR__COMMAND_REQUEST, BleInputProperty.notification);
    }*/
  }
              ...
              ElevatedButton(
                ...
                onPressed: connecting
                    ...
                    : () {
                        ...
                        for (var deviceId in widget.selectedItems) {
